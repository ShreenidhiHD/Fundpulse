                 ...
                 <!-- Start Box Body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="radio">
                        <label class="padding-zero">
                          <input  type="radio" name="payment_gateway" value="BankTransfer" class="custom-control-input paymentGateway">
                        Bank Transfer
                        </label>
                      </div>
                    @foreach (PaymentGateways::where('enabled', '1')->where('type', '<>', 'bank')->orderBy('type')->get(); as $payment)
                      	...
                      	<div class="radio">
                        <label class="padding-zero">
                          <input @if (PaymentGateways::where('enabled', '1')->where('type', '<>', 'bank')->count() == 1)  @endif type="radio" name="payment_gateway" value="{{$payment->name}}" class="custom-control-input paymentGateway">
                          {{ $payment->name }}
                        </label>
                      </div>
                    @endforeach
