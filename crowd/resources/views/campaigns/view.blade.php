		 ...
		 <div class="col-md-8">
			 ...
			 <ul class="nav nav-tabs nav-fill">
			   <li class="nav-item active"><a href="#desc" aria-controls="home" role="tab" data-toggle="tab" class="nav-link active text-dark py-3"><strong>{{ trans('misc.story') }}</strong></a></li>
				 ...
				 <li class="nav-item text-muted" style="display: none;"><a href="#comments" aria-controls="home" role="tab" data-toggle="tab" class="nav-link text-dark py-3"><strong>{{ trans('misc.comments') }}</strong></a></li>
			 </ul>
